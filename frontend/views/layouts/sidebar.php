...
<div class="col-sm-12 col-xs-12 col-lg-12" style="background-color:#EEAA44;margin-bottom:5px;">
	<h4 class="center-block">Sign Up Now</h4>
</div>
<div class="well well-lg" style="padding-bottom:5px;">
	<?php $form = ActiveForm::begin([
		'id' => 'desktop',
		'action' => Url::to(['account/signup'])
	]) ?>
		<div class="row">
			<div class="col-xs-12 form-group" style="margin-bottom:5px;">
				<?= $form->field($model, 'firstname'); ?>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 form-group" style="margin-bottom:5px;">
				<?= $form->field($model, 'lastname')->textInput()->label('Surname'); ?>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 form-group" style="margin-bottom:5px;">
		...
		<div class="row">
			<div class="col-xs-12 form-group" style="margin-bottom:5px;">
				<?= $form->field($model, 'confirmPassword')->passwordInput()->label('Repeat Password'); ?>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label style="font-weight:normal;line-height:1rem;">Signing up as</label>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="checkbox">
					<?= $form->field($model, 'tcs')->checkbox(['label' => '' . $terms, 'uncheck' => null])->label(false) ?>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-xs-12 col-lg-12">
				<input class="btn btn-default center-block" id="signup-button" name="signup-button" type="submit" value="Submit">
			</div>
		</div>
	<?php ActiveForm::end(); ?>
</div>
