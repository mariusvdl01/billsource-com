...
/* @var $quote common\models\invoice\Invoice */
	...
	<div class="row">
		<div class="col-sm-12">
	    	...
	    	<table class="col-sm-12">
							...
							<table class="col-sm-12">
								...
								<tr>
		                 		...
		                 		<tr>
					                ...
					                <td>Issue Date:</td>
					                <td><?= !empty($quote->issue_date) ? $quote->issue_date : $now ?></td>
				                </tr>
				                <tr>
				                 	<td>&nbsp;</td>
				                 	<td>&nbsp;</td>
					            ...
					            <?php if(!$quote->isNewRecord) : ?>
				                 	...
				                 	<td><?= $form->field($quote, 'status_id')->dropdownList($statuses)->label(false)?></td>
				                <?php endif; ?>
				                 	<td>&nbsp;</td>
				                 	<td>&nbsp;</td>
				                </tr>
				                ...
				                <tr>
                 					...
                 					<td><?= $form->field($quote, 'reference_number', [
		    								'inputOptions' => [
		    									'class' 	  => 'form-control',
		    								]
                 					...
                 					<td><?= $form->field($quote, 'client_vat', [
		    								'inputOptions' => [
		    									'class' 	  => 'form-control',
		    								]
		    							])->textInput(['readonly' => $quote->isNewRecord ? false : true])->label(false) ?></td>
                 				</tr>
                 				<tr>
                 					<td class="text-center">Customer Name<font color="#CC0000">*</font></td>
                 					<td><?= $form->field($quote, 'alt_business_name', [
		    								'inputOptions' => [
		    									'class' 	  => 'form-control',
		    								]
		   								])->textInput(['readonly' => $quote->isNewRecord ? false : true])->label(false) ?>
		   							</td>
				                 	<td class="text-center">ID / Reg No.</td>
				                 	<td><?= $form->field($quote, 'client_id', [
		    							'inputOptions' => [
		    								'class' 	  => 'form-control',
		    							]
		    						])->textInput(['readonly' => $quote->isNewRecord ? false : true])->label(false) ?></td>
				                ...
				                <tr>
				                 	...
				                 	<td><?= $form->field($quote, 'client_mobile', [
		    							'inputOptions' => [
		    								'class' 	  => 'form-control',
		    							]
		    						])->textInput(['readonly' => $quote->isNewRecord ? false : true])->label(false)?></td>
		    						<td class="text-center">Terms<font color="#CC0000">*</font></td>
		    						<td><?= $form->field($quote, 'comments')->dropDownList($terms)->label(false) ?></td>
				                </tr>
				                <tr>
				                	<td class="text-center">Email<font color="#CC0000">*</font></td>
				                	<td><?= $form->field($quote, 'client_email', [
		    								'inputOptions' => [
		    									'class' 	  => 'form-control',
		    								]
		    							])->textInput(['readonly' => $quote->isNewRecord ? false : true])->label(false) ?>
                 					...
                 					<td>
                 						<?= $form->field($quote, 'due_date')->label(false)->widget(DatePicker::className(), [
												'name' => 'due_date', 
											    'value' => '',
							...
							<table id="items" class="col-sm-12">
            					...
            					<tfoot>						
	                 				<tr>
                 						...
                 						<td><?= $form->field($quote, 'discount')->textInput([
                 								'value' => $quote->isNewRecord ? 0 : $quote->discount,
                 					...
                 					<tr>
						                <td></td>
						                <td><?= $form->field($quote, 'amount')->hiddenInput()->label(false) ?></td>
						                <td align="right">Sub Total&nbsp;&nbsp;</td>
						                <td><?= $form->field($quote, 'subtotal')->textInput([
						                		'readonly'	=> true,
						                		'style'	=> 'width:120px;margin:0 5px',
						                ])->label(false) ?>
						                </td>
						            ...
						            <tr>
					                 	<td class="text-center">Marketing<font color="#CC0000">*</font></td>
					                 	<td></td>
					                 	<td align="right">V.A.T. @ 14%&nbsp;&nbsp;</td>
					                 	<td><?= $form->field($quote, 'vat')->textInput([
					                 			'readonly' => true,
					                 			'style'	=> 'width:120px;margin:0 5px',
					                 		])->label(false) ?>
					                 	</td>
					                ...
					                <tr>
					                 	<td><?= $form->field($quote, 'marketing')->textarea([
                                                'class' => 'form-control',
                                                'style' => 'resize:none;'
                                            ])->label(false) ?></td>
					                 	<td></td>
					                 	<td align="right" style="color:green"><strong>Total&nbsp;&nbsp;</strong></td>
					                 	<td><?= $form->field($quote, 'total')->textInput([
					                 			'readonly' => true,
					                 			'style'	=> 'width:120px;margin:0 5px',
					                 		])->label(false) ?>
					                 	</td>
			    ...
			    <div class="form-group">
			    	<?= Html::a(Yii::t('app', 'Never mind'), ['/business/quote'], ['class'=>'btn btn-default']) ?>
			      	<?= Html::a(Yii::t('app', 'Add Item'), '#', [
           			...
           			<?= Html::submitButton(
			        	$quote->isNewRecord ? Yii::t('app', 'Create Quote') : Yii::t('app', 'Update Quote'), 
			        	['class' => $quote->isNewRecord ? 'btn btn-primary' : 'btn btn-success']) 
			        ?>
			    </div>
			    <?php ActiveForm::end(); ?>
			</div>
