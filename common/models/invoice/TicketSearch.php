...
/**
 * TicketSearch represents the model behind the search form about `common\models\invoice\Ticket`.
 */
class TicketSearch extends Invoice
{
    /**
     * @inheritdoc
     */
     ...
     */
    public function searchTickets($client, $params, $status_id, $type = 'TCK')
    {
        $query = Ticket::find();
