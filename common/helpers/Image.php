...
class Image extends \yii\base\Object
{
     ...
     */
    const IMAGE_BOXED = 0;
    const IMAGE_NOT_BOXED = 1;
    const IMAGE_CROP_TOPLEFT = 2;
    const IMAGE_CROP_TOPCENTER = 3;
    const IMAGE_CROP_TOPRIGHT = 4;
    const IMAGE_CROP_MIDDLELEFT = 5;
    const IMAGE_CROP_CENTER = 6;
    const IMAGE_CROP_MIDDLERIGHT = 7;
    const IMAGE_CROP_BOTTOMLEFT = 8;
    const IMAGE_CROP_BOTTOMCENTER = 9;
    const IMAGE_CROP_BOTTOMRIGHT = 10;
    /**
     ...
     *  {@link target_path}.
     *
     *  <samp>This method is available only if the {@link http://php.net/manual/en/function.imagefilter.php
     * imagefilter}
     ...
     *
     *                              -   <b>brightness</b>       -   changes the brightness of the image; use
     *     <b>arg1</b>
     *                                                              to set the level of brightness; the range of
     *     brightness is -255 to 255;
     *                              -   <b>colorize</b>         -   adds (subtracts) specified RGB values to each
     *     pixel;
     *                                                              use <b>arg1</b>, <b>arg2</b> and <b>arg3</b> in the
     *                                                              form of red, green, blue and <b>arg4</b> for the
     *     alpha channel. the range for each color is -255 to 255 and
     *                                                              0 to 127 for alpha; <i>alpha support is available
     *     only for PHP 5.2.5+</i>;
     ...
     *                              -   <b>edgedetect</b>       -   uses edge detection to highlight the edges in the
     *     image;
     ...
     *                              -   <b>pixelate</b>         -   applies pixelation effect to the image, use
     *     <b>arg1</b> to set the block size and <b>arg2</b> to set the pixelation effect mode; <i>this filter is
     *     available only for PHP 5.3.0+</i>;
     *                              -   <b>selective_blur</b>   -   blurs the image;
     *                              -   <b>smooth</b>           -   makes the image smoother. Use <b>arg1</b> to set
     *     the
     *                                                              level of smoothness. applies a 9-cell convolution
     *     matrix where center pixel has the weight of <b>arg1</b> and others weight of 1.0. the result is normalized
     *     by dividing the sum with <b>arg1</b> + 8.0 (sum of the matrix). any float is accepted;
     *
     ...
     *                              -   <b>pixelate</b>         -   whether to use advanced pixelation effect or not
     *     (defaults to FALSE).
     *
     ...
     *                              -   <b>colorize</b>         -   alpha channel; a value between 0 and 127. 0
     ...
     *                              {@link http://php.net/manual/en/function.imagefilter.php imagefilter} exists and
     *     that the requested filter is valid, check the {@link error} property to see the error code.
     */
     ...
     *                                          <b>height</b> arguments are values greater than <b>0</b>, the image
     *     will
     ...
     *
     *                                          If set to <b>0</b>, the height will be automatically adjusted,
     *     depending
     ...
     *     the
     *                                          <b>width</b> and <b>height</b> arguments are values greater than
     *     <b>0</b>, the image will be resized to the exact given width and height and the aspect ratio will be
     *     preserved by using on of the following methods:
     *
     *                                          -   <b>IMAGE_BOXED</b> - the image will be scalled so that it will
     *                                              fit in a box with the given width and height (both width/height
     *     will
     *                                              be smaller or equal to the required width/height) and then it will
     *                                              be centered both horizontally and vertically. The blank area will
     *     be
     *                                              filled with the color specified by the <b>bgcolor</b> argument.
     *     (the
     *                                              blank area will be filled only if the image is not transparent!)
     *
     *                                          -   <b>IMAGE_NOT_BOXED</b> - the image will be scalled so that it
     *                                              <i>could</i> fit in a box with the given width and height but will
     *                                              not be enclosed in a box with given width and height. The new
     *     width/
     *                                              height will be both smaller or equal to the required width/height
     *
     *                                          -   <b>IMAGE_CROP_TOPLEFT</b>
     *                                          -   <b>IMAGE_CROP_TOPCENTER</b>
     *                                          -   <b>IMAGE_CROP_TOPRIGHT</b>
     *                                          -   <b>IMAGE_CROP_MIDDLELEFT</b>
     *                                          -   <b>IMAGE_CROP_CENTER</b>
     *                                          -   <b>IMAGE_CROP_MIDDLERIGHT</b>
     *                                          -   <b>IMAGE_CROP_BOTTOMLEFT</b>
     *                                          -   <b>IMAGE_CROP_BOTTOMCENTER</b>
     *                                          -   <b>IMAGE_CROP_BOTTOMRIGHT</b>
     *
     *                                          For the methods involving crop, first the image is scaled so that both
     *                                          its sides are equal or greater than the respective sizes of the
     *     bounding
     ...
     *
     *                                          When set to -1 the script will preserve transparency for transparent
     *     GIF
     ...
     *                                          wrong
     */
    public function resize($width = 0, $height = 0, $method = self::IMAGE_CROP_CENTER, $background_color = '#FFFFFF')
    {
            ...
            if (
                ...
                if (
                    ...
                    switch ($method) {
                        ...
                        case self::IMAGE_CROP_TOPCENTER:
                        ...
                        case self::IMAGE_CROP_MIDDLELEFT:
                        ...
                        case self::IMAGE_CROP_MIDDLERIGHT:
                        ...
                        case self::IMAGE_CROP_BOTTOMLEFT:
                        ...
                        case self::IMAGE_CROP_BOTTOMCENTER:
                        ...
                        case self::IMAGE_CROP_BOTTOMRIGHT:
    ...
    /**
     *  Crops a portion of the image given as {@link source_path} and outputs it as the file specified as {@link
     * target_path}.
     *
     *  <code>
     *  // include the Zebra_Image library
